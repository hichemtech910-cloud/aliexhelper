...
const tiktokRight = document.getElementById('tiktokRight');
const tiktokLeft = document.getElementById('tiktokLeft');
const tiktokDots = document.querySelectorAll('.tiktok-dot');
const tiktokItems = document.querySelectorAll('.tiktok-item');
let tiktokCurrent = 0;
const tiktokCount = tiktokItems.length;

function showTiktokSlide(index) {
    if (!tiktokSlides) return;
    tiktokItems.forEach(item => item.classList.remove('active'));
    tiktokDots.forEach(dot => dot.classList.remove('active'));
    tiktokItems[index].classList.add('active');
    tiktokDots[index].classList.add('active');
    tiktokSlides.style.transform = `translateX(-${index * 100}%)`;
}

if (tiktokRight) {
    tiktokRight.addEventListener('click', () => {
        tiktokCurrent = (tiktokCurrent + 1) % tiktokCount;
        showTiktokSlide(tiktokCurrent);
    });
}

if (tiktokLeft) {
    tiktokLeft.addEventListener('click', () => {
        tiktokCurrent = (tiktokCurrent - 1 + tiktokCount) % tiktokCount;
        showTiktokSlide(tiktokCurrent);
    });
}

tiktokDots.forEach(dot => {
    dot.addEventListener('click', () => {
        tiktokCurrent = parseInt(dot.dataset.index);
        showTiktokSlide(tiktokCurrent);
    });
});
